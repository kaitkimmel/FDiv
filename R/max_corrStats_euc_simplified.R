...
fevemod_cdre1 <- lme(FEve ~ max_cor, random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
fdivmod_cdre1 <- lme(FDiv ~ max_cor, random = ~1|Plot,  data = cdre.1, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
fricmod_cdre2 <- lme(FRic ~ max_cor + I(max_cor^2), random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod4) ## mod1
anova(mod1, mod) #use mod
fevemod_cdre2 <- lme(FEve ~ max_cor, random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
fdivmod_cdre2 <- lme(FDiv ~ max_cor, random = ~1|Plot,  data = cdre.2, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod
kde.alphamod_cdre3 <- lme(kde.alpha ~ max_cor, random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod
kde.dispersionmod_cdre3 <- lme(kde.dispersion ~ max_cor, random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
fdismod_cdre4 <- lme(FDis ~ max_cor, random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
raoqmod_cdre4 <- lme(RaoQ ~ max_cor, random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
