...
anova(mod1, mod, mod4) #all same, us mod4
fricmod_eblue <- lme(FRic ~ 1, random = ~1|sev.blueplots,  data = seve.eblue[-which(is.na(seve.eblue$FRic)),], correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod1
anova(mod1, mod, mod4) #all sam use mod4
fdivmod_eblue <- lme(FDiv ~ 1, random = ~1|sev.blueplots,  data = seve.eblue[-which(is.na(seve.eblue$FDiv)),], method = "ML", correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
raoqmod_eblue <- lme(RaoQ ~ max_cor, random = ~1|sev.blueplots,  data = seve.eblue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) ##mod1
anova(mod1, mod)
fevemod_cdre1 <- lme(FEve ~ max_cor + I(max_cor^2), random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_cdre3 <- lme(FDiv ~ max_cor + I(max_cor^2), random = ~1|Plot,  data = cdre.3, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ## mod1
fevemod_cdre4 <- lme(FEve ~ max_cor + I(max_cor^2), random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
