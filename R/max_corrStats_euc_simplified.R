...
AIC(mod, mod1, mod4) #mod3 best fit
...
AIC(mod, mod1, mod4) ### mod1-3 similar
...
AIC(mod, mod1, mod4) #mod2-mod3 similar
...
cdre.4, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
