...
AIC(mod, mod1, mod4) ### mod
kde.alphamod_blue <- lme(kde.alpha ~ max_cor, random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1,  mod4) ### mod
kde.evennessmod_blue <- lme(kde.evenness ~ max_cor, random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod1
fdismod_blue <- lme(FDis ~ max_cor + I(max_cor^2), random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
kde.dispersionmod_blue <- lme(kde.dispersion ~ 1, random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod
fdivmod_blue <- lme(FDiv ~ max_cor, random = ~1|sev.blueplots,  data = sev.blue[-which(is.na(sev.blue$FDiv)),], method = "ML", correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod
raoqmod_blue <- lme(RaoQ ~ max_cor, random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1,  mod4) ### mod1
kde.alphamod_black <- lme(kde.alpha ~ max_cor + I(max_cor^2), random = ~1|sev.blackplots,  data = sev.black, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) ## mod
anova(mod, mod4) # no sig dif use mod4
...
AIC(mod, mod1, mod4) #mod1
fdismod_black <- lme(FDis ~ max_cor + I(max_cor^2), random = ~1|sev.blackplots,  data = sev.black, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) ### mod1
kde.dispersionmod_black <- lme(kde.dispersion ~ max_cor + I(max_cor^2), random = ~1|sev.blackplots,  data = sev.black, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_black <- lme(FDiv ~ max_cor + I(max_cor^2), random = ~1|sev.blackplots,  data = sev.black[-which(is.na(sev.black$FDiv)),], method = "ML", correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) #mod
fdismod_cdr1 <- lme(FDis ~ max_cor, random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
fdivmod_cdr1 <- lme(FDiv ~ max_cor, random = ~1|Plot,  data = cdr.1, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
raoqmod_cdr1 <- lme(RaoQ ~ max_cor, random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod
anova(mod, mod4) #no dif use mod4
kde.alphamod_cdr2 <- lme(kde.alpha ~ 1, random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod4
kde.evennessmod_cdr3 <- lme(kde.evenness ~ 1, random = ~1|Plot,  data = cdr.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
fricmod_cdr4 <- lme(FRic ~ max_cor+ I(max_cor^2), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.alphamod_cdr4 <- lme(kde.alpha ~ max_cor + I(max_cor^2), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdismod_cdr4 <- lme(FDis ~ max_cor+ I(max_cor^2), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.dispersionmod_cdr4 <- lme(kde.dispersion ~ max_cor+ I(max_cor^2), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_cdr4 <- lme(FDiv ~ max_cor+ I(max_cor^2), random = ~1|Plot,  data = cdr.4, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
raoqmod_cdr4 <- lme(RaoQ ~ max_cor + I(max_cor^2), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
