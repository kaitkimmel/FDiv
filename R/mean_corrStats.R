...
fdiv.1$mean_cor <- seq(min(cdr.1$min_cor), max(cdr.1$min_cor), by = 0.01)
...
rq.1$mean_cor <- seq(min(cdr.1$min_cor), max(cdr.1$min_cor), by = 0.01)
...
kde.alpha.1$mean_cor <- seq(min(cdr.1$min_cor), max(cdr.1$min_cor), by = .01)
...
kde.evenness.1$mean_cor <- seq(min(cdr.1$min_cor), max(cdr.1$min_cor), by = .01)
...
kde.dispersion.1$mean_cor <- seq(min(cdr.1$min_cor), max(cdr.1$min_cor), by = .01)
...
fdiv.2$mean_cor <- seq(min(cdr.2$min_cor), max(cdr.2$min_cor), by = .01)
...
rq.2$mean_cor <- seq(min(cdr.2$min_cor), max(cdr.2$min_cor), by = .01)
...
kde.alpha.2$mean_cor <- seq(min(cdr.2$min_cor), max(cdr.2$min_cor), by = .01)
...
kde.evenness.2$mean_cor <- seq(min(cdr.2$min_cor), max(cdr.2$min_cor), by = .01)
...
kde.dispersion.2$mean_cor <- seq(min(cdr.2$min_cor), max(cdr.2$min_cor), by = .01)
...
fdiv.3$mean_cor <- seq(min(cdr.3$min_cor), max(cdr.3$min_cor), by = .01)
...
rq.3$mean_cor <- seq(min(cdr.3$min_cor), max(cdr.3$min_cor), by = .01)
...
kde.alpha.3$mean_cor <- seq(min(cdr.3$min_cor), max(cdr.3$min_cor), by = .01)
...
kde.evenness.3$mean_cor <- seq(min(cdr.3$min_cor), max(cdr.3$min_cor), by = .01)
...
kde.dispersion.3$mean_cor <- seq(min(cdr.3$min_cor), max(cdr.3$min_cor), by = .01)
...
fdiv.4$mean_cor <- seq(min(cdr.4$min_cor), max(cdr.4$min_cor), by = .01)
...
rq.4$mean_cor <- seq(min(cdr.4$min_cor), max(cdr.4$min_cor), by = .01)
...
kde.alpha.4$mean_cor <- seq(min(cdr.4$min_cor), max(cdr.4$min_cor), by = .01)
...
kde.evenness.4$mean_cor <- seq(min(cdr.4$min_cor), max(cdr.4$min_cor), by = .01)
...
kde.dispersion.4$mean_cor <- seq(min(cdr.4$min_cor), max(cdr.4$min_cor), by = .01)
...
new.df5 <- data.frame(mean_cor = seq(min(sev.blue$min_cor), max(sev.blue$min_cor), by = 0.01))
fr.blue <- as.data.frame(predictSE.lme(fricmod_blue, new.df5))
fr.blue$mean_cor <- seq(min(sev.blue$min_cor), max(sev.blue$min_cor), by = 0.01)
...
fe.blue$mean_cor <- seq(min(sev.blue$min_cor), max(sev.blue$min_cor), by = 0.01)
...
fdis.blue$mean_cor <- seq(min(sev.blue$min_cor), max(sev.blue$min_cor), by = 0.01)
...
fdiv.blue$mean_cor <- seq(min(sev.blue$min_cor), max(sev.blue$min_cor), by = 0.01)
...
rq.blue$mean_cor <- seq(min(sev.blue$min_cor), max(sev.blue$min_cor), by = 0.01)
...
kde.alpha.blue$mean_cor <- seq(min(sev.blue$min_cor), max(sev.blue$min_cor), by = .01)
...
kde.evenness.blue$mean_cor <- seq(min(sev.blue$min_cor), max(sev.blue$min_cor), by = .01)
...
kde.dispersion.blue$mean_cor <- seq(min(sev.blue$min_cor), max(sev.blue$min_cor), by = .01)
...
new.df6 <- data.frame(mean_cor = seq(min(sev.black$min_cor), max(sev.black$min_cor), by = 0.01))
fr.black <- as.data.frame(predictSE.lme(fricmod_black, new.df6))
fr.black$mean_cor <- seq(min(sev.black$min_cor), max(sev.black$min_cor), by = .01)
...
fe.black$mean_cor <- seq(min(sev.black$min_cor), max(sev.black$min_cor), by = .01)
...
fdis.black$mean_cor <- seq(min(sev.black$min_cor), max(sev.black$min_cor), by = .01)
...
fdiv.black$mean_cor <- seq(min(sev.black$min_cor), max(sev.black$min_cor), by = .01)
...
rq.black$mean_cor <- seq(min(sev.black$min_cor), max(sev.black$min_cor), by = .01)
...
kde.alpha.black$mean_cor <- seq(min(sev.black$min_cor), max(sev.black$min_cor), by = .01)
...
kde.evenness.black$mean_cor <- seq(min(sev.black$min_cor), max(sev.black$min_cor), by = .01)
...
kde.dispersion.black$mean_cor <- seq(min(sev.black$min_cor), max(sev.black$min_cor), by = .01)
