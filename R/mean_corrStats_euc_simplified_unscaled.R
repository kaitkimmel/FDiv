...
fricmod_eblue <- lme(FRic ~ mean_cor, random = ~1|sev.blueplots,  data = seve.eblue[-which(is.na(seve.eblue$FRic)),], correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod
fdismod_eblue <- lme(FDis ~ mean_cor, random = ~1|sev.blueplots,  data = seve.eblue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) ### mod1
kde.dispersionmod_eblue <- lme(kde.dispersion ~ mean_cor + I(mean_cor^2), random = ~1|sev.blueplots,  data = seve.eblue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_eblue <- lme(FDiv ~ mean_cor + I(mean_cor^2), random = ~1|sev.blueplots,  data = seve.eblue[-which(is.na(seve.eblue$FDiv)),], method = "ML", correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod1
raoqmod_eblue <- lme(RaoQ ~ mean_cor + I(mean_cor^2), random = ~1|sev.blueplots,  data = seve.eblue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) ### mod
fricmod_eblack <- lme(FRic ~ mean_cor, random = ~1|sev.blackplots,  data = seve.eblack[-which(is.na(seve.eblack$FRic)),], correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) ### mod
kde.alphamod_eblack <- lme(kde.alpha ~ mean_cor, random = ~1|sev.blackplots,  data = seve.eblack, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) ## mod1
fevemod_cdre3 <- lme(FEve ~ mean_cor + I(mean_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
anova(mod1, mod4)
kde.evennessmod_cdre3 <- lme(kde.evenness ~  mean_cor + I(mean_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
anova(mod1, mod) 
fdismod_cdre3 <- lme(FDis ~ mean_cor + I(mean_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
raoqmod_cdre3 <- lme(RaoQ ~ mean_cor + I(mean_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod
fricmod_cdre4 <- lme(FRic ~ mean_cor, random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ## mod4  
fevemod_cdre4 <- lme(FEve ~ 1, random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod4
fdismod_cdre4 <- lme(FDis ~ 1, random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
