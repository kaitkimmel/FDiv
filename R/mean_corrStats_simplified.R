...
kde.evennessmod_blue <- lme(kde.evenness ~ mean_cor + I(mean_cor^2), random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod1
anova(mod1, mod4) #no dif use mod4
fdismod_blue <- lme(FDis ~ 1, random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod1
anova(mod1, mod)
fdivmod_blue <- lme(FDiv ~ mean_cor + I(mean_cor^2), random = ~1|sev.blueplots,  data = sev.blue[-which(is.na(sev.blue$FDiv)),], method = "ML", correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
raoqmod_blue <- lme(RaoQ ~ mean_cor, random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1,  mod4) ### mod1
fricmod_cdr1 <- lme(FRic ~ mean_cor + I(mean_cor^2), random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,  mod4) ### mod1
kde.alphamod_cdr1 <- lme(kde.alpha ~ mean_cor + I(mean_cor^2), random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdismod_cdr1 <- lme(FDis ~ mean_cor+ I(mean_cor^2), random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
raoqmod_cdr1 <- lme(RaoQ ~ mean_cor, random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,  mod4) ### mod1
fricmod_cdr2 <- lme(FRic ~ mean_cor + I(mean_cor^2), random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,  mod4) ### mod1
anova(mod1, mod) #no dif use mod
kde.alphamod_cdr2 <- lme(kde.alpha ~ mean_cor, random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_cdr2 <- lme(FDiv ~ mean_cor+ I(mean_cor^2), random = ~1|Plot,  data = cdr.2, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,  mod4) ### mod1
kde.alphamod_cdr3 <- lme(kde.alpha ~ mean_cor+ I(mean_cor^2), random = ~1|Plot,  data = cdr.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ## mod4 best fit
...
AIC(mod, mod1,  mod4) ### mod & mod4 similar - use mod4
...
AIC(mod, mod1,  mod4) ### mod
fricmod_cdr4 <- lme(FRic ~ mean_cor, random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,  mod4) ### mod1
kde.alphamod_cdr4 <- lme(kde.alpha ~ mean_cor+ I(mean_cor^2), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,  mod4) ### mod1
kde.evennessmod_cdr4 <- lme(kde.evenness ~ mean_cor+ I(mean_cor^2), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
fdismod_cdr4 <- lme(FDis ~ mean_cor, random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,  mod4) ### mod1
kde.dispersionmod_cdr4 <- lme(kde.dispersion ~ mean_cor+ I(mean_cor^2), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
raoqmod_cdr4 <- lme(RaoQ ~ mean_cor, random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
