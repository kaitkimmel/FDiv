...
Frich_g <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = fr.1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FRic, color = community), data = cdr.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.blue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.black, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FRic, color = community), data = sev.full, size = 2, alpha = 0.5) + 
...
FEve_g <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = fe.1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FEve, color = community), data = cdr.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.blue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.black, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FEve, color = community), data = sev.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
...
FDis_g <-ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = fdis.1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
...
FDiv_g <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = fdiv.1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdiv.2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdiv.3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdiv.4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FDiv, color = community), data = cdr.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdiv.blue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdiv.black, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FDiv, color = community), data = sev.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
...
RaoQ_g <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = rq.1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
...
kderichness_g <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.alpha, color = community), data = cdr.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.blue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.black, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.alpha, color = community), data = sev.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
...
kdeevenness_g <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.evenness, color = community), data = cdr.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.blue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.black, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.evenness, color = community), data = sev.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
...
kdedispersion_g <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.dispersion, color = community), data = cdr.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.blue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.black, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.dispersion, color = community), data = sev.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
...
Frich_e <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = fr.e1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.e2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.e3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.e4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FRic, color = community), data = cdre.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.eblue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fr.eblack, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FRic, color = community), data = seve.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
  labs(x = "Minimum Trait-Trait Correlation", y = "FRich") +
  theme_pubr()
...
FEve_e <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = fe.e1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.e2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.e3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.e4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FEve, color = community), data = cdre.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.eblue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fe.eblack, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FEve, color = community), data = seve.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
  labs(x = "Minimum Trait-Trait Correlation", y = "FEve") +
  theme_pubr()
...
FDis_e <-ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = fdis.e1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdis.e2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdis.e3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdis.e4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FDis, color = community), data = cdre.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdis.eblue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = fdis.eblack, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = FDis, color = community), data = seve.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
  labs(x = "Minimum Trait-Trait Correlation", y = "FDis") +
  theme_pubr()
...
FDiv_e <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = fdiv.e1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
...
RaoQ_e <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = rq.e1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = rq.e2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = rq.e3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = rq.e4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = RaoQ, color = community), data = cdre.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = rq.eblue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = rq.eblack, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = RaoQ, color = community), data = seve.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
  labs(x = "Minimum Trait-Trait Correlation", y = "Rao Q") +
  theme_pubr()
...
kderichness_e <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.e1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.e2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.e3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.e4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.alpha, color = community), data = cdre.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.eblue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.alpha.eblack, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.alpha, color = community), data = seve.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
  labs(x = "Minimum Trait-Trait Correlation", y = "KDE Richness") +
  theme_pubr()
...
kdeevenness_e <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.e1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.e2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.e3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.e4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.evenness, color = community), data = cdre.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.eblue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.evenness.eblack, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.evenness, color = community), data = seve.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
  labs(x = "Minimum Trait-Trait Correlation", y = "KDE Evenness") +
  theme_pubr()
...
kdedispersion_e <- ggplot() + 
  ...
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.e1, lwd = 1, color = "#9D8F0F", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.e2, lwd = 1, color = "#731279", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.e3, lwd = 1, color = "#00B7FF", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.e4, lwd = 1, color = "#075A13", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.dispersion, color = community), data = cdre.full, size = 2, alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.eblue, lwd = 1, color = "navyblue", alpha = 0.5) + 
  geom_line(aes(x= min_cor, y = fit), data = kde.dispersion.eblack, lwd = 1, color = "black", alpha = 0.5) + 
  geom_point(aes(x = min_cor, y = kde.dispersion, color = community), data = seve.full, size = 2, alpha = 0.5) + 
  scale_color_manual(values = c("#9D8F0F","#731279", "#00B7FF", "#075A13","#000000", "navyblue"), name = "Community") +
  labs(x = "Minimum Trait-Trait Correlation", y = "KDE Dispersion") +
  theme_pubr()

pdf(here('Figures/min_cor_full.pdf'), height = 9, width = 12)#, units = 'in', res = 150)
