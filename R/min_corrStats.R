...
AIC(mod, mod1, mod2, mod3) ### all similar
anova(mod, mod1) # sig different, using mod1
...
AIC(mod, mod1,mod2, mod3) #mod2 and 3 similar best fit
anova(mod2, mod3)# not sig diff- using mod 2
...
anova(mod2, mod1) # not sig diff - mod1
kde.evennessmod_cdr2 <- lme(kde.evenness ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod2 and 1 similar
anova(mod3, mod2, mod1) ##not sig dif use mod1
kde.dispersionmod_cdr2 <- lme(kde.evenness ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod and mod 3 similar - use mod
fdivmod_cdr2 <- lme(FDiv ~ min_cor, random = ~1|Plot,  data = cdr.2, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod2
raoqmod_cdr2 <- lme(RaoQ ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod2
anova(mod3, mod2)
fricmod_cdr4 <- lme(FRic ~ min_cor+ I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod2
kde.alphamod_cdr4 <- lme(kde.alpha ~ min_cor+ I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod2
fdismod_cdr4 <- lme(FDis ~ min_cor+ I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod2
kde.dispersionmod_cdr4 <- lme(kde.dispersion ~ min_cor+ I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod2 and mod3 similar - using mod 2
