...
modnull <- lme(FRic~1, random = ~1|sev.blueplots,  data = sev.blue[-which(is.na(sev.blue$FRic)),], method = "ML",correlation = corCompSymm(form = ~ 1|sev.blueplots))

AIC(mod, mod1, mod2, mod3) ### mod2
fricmod_blue <- lme(FRic ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|sev.blueplots,  data = sev.blue[-which(is.na(sev.blue$FRic)),], correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod2, mod3) ### mod2
anova(mod1, mod2)
kde.alphamod_blue <- lme(kde.alpha ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
anova(mod, mod3)
fevemod_blue <- lme(FEve ~ min_cor  + I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|sev.blueplots,  data = sev.blue[-which(is.na(sev.blue$FEve)),], correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
kde.evennessmod_blue <- lme(kde.evenness ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
fdismod_blue <- lme(FDis ~ min_cor + I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod2, mod3) ### mod2
kde.dispersionmod_blue <- lme(kde.dispersion ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1,mod2, mod3) #mod2
fdivmod_blue <- lme(FDiv ~ min_cor  + I(min_cor^2) + I(min_cor^3), random = ~1|sev.blueplots,  data = sev.blue[-which(is.na(sev.blue$FDiv)),], method = "ML", correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1,mod2, mod3) #mod2
raoqmod_blue <- lme(RaoQ ~ min_cor  + I(min_cor^2) + I(min_cor^3), random = ~1|sev.blueplots,  data = sev.blue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
fricmod_black <- lme(FRic ~ min_cor + I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|sev.blackplots,  data = sev.black[-which(is.na(sev.black$FRic)),], correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod2, mod3) ### mod3
kde.alphamod_black <- lme(kde.alpha ~ min_cor + I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|sev.blackplots,  data = sev.black, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1,mod2, mod3) #mod3 best
...
AIC(mod, mod1,mod2, mod3) #mod3
raoqmod_black <- lme(RaoQ ~ min_cor + I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|sev.blackplots,  data = sev.black, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod2, mod3) ### mod3
fricmod_cdr1 <- lme(FRic ~ min_cor + I(min_cor^2)+ I(min_cor^3) + I(min_cor^4), random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) ## mod
fevemod_cdr1 <- lme(FEve ~ min_cor, random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
anova(mod1, mod)
kde.evennessmod_cdr1 <- lme(kde.evenness ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod3
fdismod_cdr1 <- lme(FDis ~ min_cor+ I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod3
fdivmod_cdr1 <- lme(FDiv ~ min_cor + I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|Plot,  data = cdr.1, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod3
raoqmod_cdr1 <- lme(RaoQ ~ min_cor + I(min_cor^2) + I(min_cor^3)+ I(min_cor^4), random = ~1|Plot,  data = cdr.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod3
fricmod_cdr2 <- lme(FRic ~ min_cor + I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod3
kde.alphamod_cdr2 <- lme(kde.alpha ~ min_cor + I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod2
kde.evennessmod_cdr2 <- lme(kde.evenness ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod2
anova(mod2, mod1) #no dif use mod1
...
AIC(mod, mod1, mod2, mod3) ### mod2
kde.dispersionmod_cdr2 <- lme(kde.evenness ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod2
kde.alphamod_cdr3 <- lme(kde.alpha ~ min_cor+ I(min_cor^2)+ I(min_cor^3), random = ~1|Plot,  data = cdr.3, correlation = corCompSymm(form = ~ 1|Plot))
...
fevemod_cdr3 <- lme(FEve ~ min_cor, random = ~1|Plot,  data = cdr.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod2
kde.evennessmod_cdr3 <- lme(kde.evenness ~ min_cor+ I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod2
fdismod_cdr3 <- lme(FDis ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod2
kde.dispersionmod_cdr3 <- lme(kde.dispersion ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod2
fdivmod_cdr3 <- lme(FDiv ~ min_cor + I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.3, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
raoqmod_cdr3 <- lme(RaoQ ~ min_cor+ I(min_cor^2) + I(min_cor^3), random = ~1|Plot,  data = cdr.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod3
kde.alphamod_cdr4 <- lme(kde.alpha ~ min_cor+ I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod2, mod3) ### mod3
anova(mod3, mod1)
kde.evennessmod_cdr4 <- lme(kde.evenness ~ min_cor+ I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod1
anova(mod1, mod) #no dif use mod
fdivmod_cdr4 <- lme(FDiv ~ min_cor, random = ~1|Plot,  data = cdr.4, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod2, mod3) #mod3
raoqmod_cdr4 <- lme(RaoQ ~ min_cor + I(min_cor^2) + I(min_cor^3) + I(min_cor^4), random = ~1|Plot,  data = cdr.4, correlation = corCompSymm(form = ~ 1|Plot))
