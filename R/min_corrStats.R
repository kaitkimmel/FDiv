...
AIC(mod, mod1, mod2, mod3, mod4) ## mod3 & 4 similar
anova(mod4, mod3) #not sig diff, use mod4
...
AIC(mod, mod1, mod2, mod3, mod4) ### mod3 lowest, similar to mod2
anova(mod2, mod3) # no sig diff - using mod2
...
AIC(mod, mod1, mod2, mod3, mod4) #mod3 best
