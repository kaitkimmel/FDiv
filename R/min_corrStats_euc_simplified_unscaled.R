...
AIC(mod, mod1, mod4) ### mod1
kde.alphamod_eblue <- lme(kde.alpha ~ min_cor + I(min_cor^2), random = ~1|sev.blueplots,  data = seve.eblue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) ## mod1
fevemod_eblue <- lme(FEve ~ min_cor + I(min_cor^2), random = ~1|sev.blueplots,  data = seve.eblue[-which(is.na(seve.eblue$FEve)),], correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod1
fdismod_eblue <- lme(FDis ~ min_cor+ I(min_cor^2), random = ~1|sev.blueplots,  data = seve.eblue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) ### mod1
kde.dispersionmod_eblue <- lme(kde.dispersion ~ min_cor + I(min_cor^2), random = ~1|sev.blueplots,  data = seve.eblue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_eblue <- lme(FDiv ~ min_cor + I(min_cor^2), random = ~1|sev.blueplots,  data = seve.eblue[-which(is.na(seve.eblue$FDiv)),], method = "ML", correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) #mod1
raoqmod_eblue <- lme(RaoQ ~ min_cor + I(min_cor^2), random = ~1|sev.blueplots,  data = seve.eblue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
fricmod_eblack <- lme(FRic ~ min_cor, random = ~1|sev.blackplots,  data = seve.eblack[-which(is.na(seve.eblack$FRic)),], correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
kde.alphamod_eblack <- lme(kde.alpha ~ min_cor, random = ~1|sev.blackplots,  data = seve.eblack, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) #mod4
fdismod_eblack <- lme(FDis ~ 1, random = ~1|sev.blackplots,  data = seve.eblack, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) ### mod1
kde.dispersionmod_eblack <- lme(kde.dispersion ~ min_cor + I(min_cor^2), random = ~1|sev.blackplots,  data = seve.eblack, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
fdivmod_eblack <- lme(FDiv ~ min_cor, random = ~1|sev.blackplots,  data = seve.eblack[-which(is.na(seve.eblack$FDiv)),], method = "ML", correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) #mod1
raoqmod_eblack <- lme(RaoQ ~ min_cor + I(min_cor^2), random = ~1|sev.blackplots,  data = seve.eblack, correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) ### mod1
fricmod_cdre1 <- lme(FRic ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.alphamod_cdre1 <- lme(kde.alpha ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod
anova(mod1, mod4) #use mod4
kde.evennessmod_cdre1 <- lme(kde.evenness ~ 1, random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdismod_cdre1 <- lme(FDis ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.dispersionmod_cdre1 <- lme(kde.dispersion ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_cdre1 <- lme(FDiv ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.1, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
raoqmod_cdre1 <- lme(RaoQ ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
fricmod_cdre2 <- lme(FRic ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.alphamod_cdre2 <- lme(kde.alpha ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ## mod
fevemod_cdre2 <- lme(FEve ~ min_cor, random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.evennessmod_cdre2 <- lme(kde.evenness ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdismod_cdre2 <- lme(FDis ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.dispersionmod_cdre2 <- lme(kde.evenness ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_cdre2 <- lme(FDiv ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.2, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
raoqmod_cdre2 <- lme(RaoQ ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
fricmod_cdre3 <- lme(FRic ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.alphamod_cdre3 <- lme(kde.alpha ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ## mod1
fevemod_cdre3 <- lme(FEve ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdismod_cdre3 <- lme(FDis ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.dispersionmod_cdre3 <- lme(kde.dispersion ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_cdre3 <- lme(FDiv ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.3, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
raoqmod_cdre3 <- lme(RaoQ ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
fricmod_cdre4 <- lme(FRic ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.alphamod_cdre4 <- lme(kde.alpha ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ## mod1
fevemod_cdre4 <- lme(FEve ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.evennessmod_cdre4 <- lme(kde.evenness ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdismod_cdre4 <- lme(FDis ~ min_cor+ I(min_cor^2), random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
kde.dispersionmod_cdre4 <- lme(kde.dispersion ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
fdivmod_cdre4 <- lme(FDiv ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.4, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1
raoqmod_cdre4 <- lme(RaoQ ~ min_cor + I(min_cor^2), random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AA <- ggplot() + 
  geom_ribbon(aes(ymin = lwr, ymax = upr, x = min_cor), data = fr.eblue, alpha = 0.5, fill = "navyblue") + 
...
CC <- ggplot() + 
  geom_ribbon(aes(ymin = lwr, ymax = upr, x = min_cor), data = fe.eblue, alpha = 0.5, fill = "navyblue") + 
...
EE <- ggplot() + 
  geom_ribbon(aes(ymin = lwr, ymax = upr, x = min_cor), data = fdis.eblue, alpha = 0.5, fill = "navyblue") + 
...
FF <- ggplot() + 
  geom_ribbon(aes(ymin = lwr, ymax = upr, x = min_cor), data = fdiv.eblue, alpha = 0.5, fill = "navyblue") + 
...
GG <- ggplot() + 
  geom_ribbon(aes(ymin = lwr, ymax = upr, x = min_cor), data = rq.eblue, alpha = 0.5, fill = "navyblue") + 
...
BB <- ggplot() + 
  geom_ribbon(aes(ymin = lwr, ymax = upr, x = min_cor), data = kde.alpha.eblue, alpha = 0.5, fill = "navyblue") + 
...
DD <- ggplot() + 
  geom_ribbon(aes(ymin = lwr, ymax = upr, x = min_cor), data = kde.evenness.eblue, alpha = 0.5, fill = "navyblue") + 
...
HH <- ggplot() + 
  geom_ribbon(aes(ymin = lwr, ymax = upr, x = min_cor), data = kde.dispersion.eblue, alpha = 0.5, fill = "navyblue") + 
