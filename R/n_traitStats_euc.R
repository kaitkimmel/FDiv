...
fdis.blue$n_trait <- seq(2, 9, by = 1)
...
fdiv.blue$n_trait <- seq(2, 9, by = 1)
...
fdis.black$n_trait <- seq(2, 9, by = 1)
...
fdiv.black$n_trait <- seq(2, 9, by = 1)
