...
cdre.4 <- read.csv(here::here("data/Cleaned/cdr4_euc.csv"))%>%
  subset(SR != "NA")
sev.eblue <- read.csv(here::here("data/Cleaned/sevblue_euc.csv"))
sev.eblack <- read.csv(here::here("data/Cleaned/sevblack_euc.csv"))
...
fricmod_eblue <- lme(FRic ~ n_trait+ I(n_trait^2), random = ~1|sev.blueplots,  data = sev.eblue[-which(is.na(sev.eblue$FRic)),], correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
fevemod_eblue <- lme(FEve ~ 1, random = ~1|sev.blueplots,  data = sev.eblue[-which(is.na(sev.eblue$FEve)),], correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
fdismod_eblue <- lme(FDis ~ n_trait, random = ~1|sev.blueplots,  data = sev.eblue, correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
fdivmod_eblue <- lme(FDiv ~ n_trait, random = ~1|sev.blueplots,  data = sev.eblue[-which(is.na(sev.eblue$FDiv)),], method = "ML", correlation = corCompSymm(form = ~ 1|sev.blueplots))
...
AIC(mod, mod1, mod4) ### mod1 similar
fricmod_eblack <- lme(FRic ~ n_trait + I(n_trait^2), random = ~1|sev.blackplots,  data = sev.eblack[-which(is.na(sev.eblack$FRic)),], correlation = corCompSymm(form = ~ 1|sev.blackplots))
...
AIC(mod, mod1, mod4) ### mod4
kde.alphamod_cdre1 <- lme(kde.alpha ~ 1, random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
fdismod_cdre1 <- lme(FDis ~ n_trait, random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
fdivmod_cdre1 <- lme(FDiv ~ n_trait, random = ~1|Plot,  data = cdre.1, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
raoqmod_cdre1 <- lme(RaoQ ~ n_trait, random = ~1|Plot,  data = cdre.1, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ## mod1 best fit
fevemod_cdre2 <- lme(FEve ~ n_trait + I(n_trait^2), random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1,mod4) #mod1 best fit
anova(mod1, mod) #use mod
fdismod_cdre2 <- lme(FDis ~ n_trait, random = ~1|Plot,  data = cdre.2, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ## mod
fevemod_cdre3 <- lme(FEve ~ n_trait, random = ~1|Plot,  data = cdre.3, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
fdivmod_cdre3 <- lme(FDiv ~ n_trait, random = ~1|Plot,  data = cdre.3, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod1
fricmod_cdre4 <- lme(FRic ~ n_trait + I(n_trait^2), random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ## mod1
anova(mod1, mod) #no dif use mod
fevemod_cdre4 <- lme(FEve ~ n_trait, random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) ### mod
kde.evennessmod_cdre4 <- lme(kde.evenness ~ n_trait, random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod1 
anova(mod1, mod) #use mod
fdismod_cdre4 <- lme(FDis ~ n_trait, random = ~1|Plot,  data = cdre.4, correlation = corCompSymm(form = ~ 1|Plot))
...
AIC(mod, mod1, mod4) #mod
fdivmod_cdre4 <- lme(FDiv ~ n_trait, random = ~1|Plot,  data = cdre.4, method = "ML", correlation = corCompSymm(form = ~ 1|Plot))
