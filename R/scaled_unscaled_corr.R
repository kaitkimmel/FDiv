...
cdr.1.sc <- read.csv(here("data/Cleaned/cdr1_sc.csv"))%>%
  subset(SR != "NA")
colnames(cdr.1.sc)[c(1:9)] <- paste(colnames(cdr.1.sc)[c(1:9)],"sc",sep="_")
cdr.2.sc <- read.csv(here("data/Cleaned/cdr2_sc.csv"))%>%
  subset(SR != "NA")
colnames(cdr.2.sc)[c(1:9)] <- paste(colnames(cdr.2.sc)[c(1:9)],"sc",sep="_")
cdr.3.sc <- read.csv(here("data/Cleaned/cdr3_sc.csv"))%>%
  subset(SR != "NA")
colnames(cdr.3.sc)[c(1:9)] <- paste(colnames(cdr.3.sc)[c(1:9)],"sc",sep="_")
cdr.4.sc <- read.csv(here("data/Cleaned/cdr4_sc.csv"))%>%
  subset(SR != "NA")
colnames(cdr.4.sc)[c(1:9)] <- paste(colnames(cdr.4.sc)[c(1:9)],"sc",sep="_")
sev.blue.sc <- read.csv(here("data/Cleaned/sevblue_sc.csv"))
colnames(sev.blue.sc)[c(1:9)] <- paste(colnames(sev.blue.sc)[c(1:9)],"sc",sep="_")
sev.black.sc <- read.csv(here("data/Cleaned/sevblack_sc.csv"))
colnames(sev.black.sc[c(1:9)]) <- paste(colnames(sev.black.sc)[c(1:9)],"sc",sep="_") 
...
sev2.comb <- left_join(sev.black, sev.black.sc, by = c("sev.blackplots", "n_trait", "traits"))

### Create one big dataset
cedar_creek <- rbind(cdr1.comb, cdr2.comb, cdr3.comb, cdr4.comb)


#correlation between the two by community
#CDR1
cdr1.FRic <- lm(FRic_sc~FRic, data = cdr1.comb)
summary(cdr1.FRic)
cor(cdr1.comb$FRic_sc, cdr1.comb$FRic)

cdr1.kde.alpha <- lm(kde.alpha_sc~kde.alpha, data = cdr1.comb)
summary(cdr1.kde.alpha)

cdr1.FEve <- lm(FEve_sc~FEve, data = cdr1.comb)
summary(cdr1.FEve)

cdr1.kde.eve <- lm(kde.evenness_sc~kde.evenness, data = cdr1.comb)
summary(cdr1.kde.eve)
cor(cdr1.comb$kde.evenness_sc, cdr1.comb$kde.evenness)

cdr1.FDis <- lm(FDis_sc~FDis, data = cdr1.comb)
summary(cdr1.FDis)

cdr1.kde.dis <- lm(kde.dispersion_sc~kde.dispersion, data = cdr1.comb)
summary(cdr1.kde.dis)

cdr1.FDiv <- lm(FDiv_sc~FDiv, data = cdr1.comb)
summary(cdr1.FDiv)

cdr1.rao <- lm(RaoQ_sc~RaoQ, data = cdr1.comb)
summary(cdr1.rao)

#CDR2

cdr2.FRic <- lm(FRic_sc~FRic, data = cdr2.comb)
summary(cdr2.FRic)

cdr2.kde.alpha <- lm(kde.alpha_sc~kde.alpha, data = cdr2.comb)
summary(cdr2.kde.alpha)

cdr2.FEve <- lm(FEve_sc~FEve, data = cdr2.comb)
summary(cdr2.FEve)

cdr2.kde.eve <- lm(kde.evenness_sc~kde.evenness, data = cdr2.comb)
summary(cdr2.kde.eve)

cdr2.FDis <- lm(FDis_sc~FDis, data = cdr2.comb)
summary(cdr2.FDis)

cdr2.kde.dis <- lm(kde.dispersion_sc~kde.dispersion, data = cdr2.comb)
summary(cdr2.kde.dis)

cdr2.FDiv <- lm(FDiv_sc~FDiv, data = cdr2.comb)
summary(cdr2.FDiv)

cdr2.rao <- lm(RaoQ_sc~RaoQ, data = cdr2.comb)
summary(cdr2.rao)

#CDR3
cdr3.FRic <- lm(FRic_sc~FRic, data = cdr3.comb)
summary(cdr3.FRic)

cdr3.kde.alpha <- lm(kde.alpha_sc~kde.alpha, data = cdr3.comb)
summary(cdr3.kde.alpha)

cdr3.FEve <- lm(FEve_sc~FEve, data = cdr3.comb)
summary(cdr3.FEve)

cdr3.kde.eve <- lm(kde.evenness_sc~kde.evenness, data = cdr3.comb)
summary(cdr3.kde.eve)

cdr3.FDis <- lm(FDis_sc~FDis, data = cdr3.comb)
summary(cdr3.FDis)

cdr3.kde.dis <- lm(kde.dispersion_sc~kde.dispersion, data = cdr3.comb)
summary(cdr3.kde.dis)

cdr3.FDiv <- lm(FDiv_sc~FDiv, data = cdr3.comb)
summary(cdr3.FDiv)

cdr3.rao <- lm(RaoQ_sc~RaoQ, data = cdr3.comb)
summary(cdr3.rao)

#CDR4
cdr4.FRic <- lm(FRic_sc~FRic, data = cdr4.comb)
summary(cdr4.FRic)

cdr4.kde.alpha <- lm(kde.alpha_sc~kde.alpha, data = cdr4.comb)
summary(cdr4.kde.alpha)

cdr4.FEve <- lm(FEve_sc~FEve, data = cdr4.comb)
summary(cdr4.FEve)

cdr4.kde.eve <- lm(kde.evenness_sc~kde.evenness, data = cdr4.comb)
summary(cdr4.kde.eve)

cdr4.FDis <- lm(FDis_sc~FDis, data = cdr4.comb)
summary(cdr4.FDis)

cdr4.kde.dis <- lm(kde.dispersion_sc~kde.dispersion, data = cdr4.comb)
summary(cdr4.kde.dis)

cdr4.FDiv <- lm(FDiv_sc~FDiv, data = cdr4.comb)
summary(cdr4.FDiv)

cdr4.rao <- lm(RaoQ_sc~RaoQ, data = cdr4.comb)
summary(cdr4.rao)


#SEV1
sev1.FRic <- lm(FRic_sc~FRic, data = sev1.comb)
summary(sev1.FRic)

sev1.kde.alpha <- lm(kde.alpha_sc~kde.alpha, data = sev1.comb)
summary(sev1.kde.alpha)

sev1.FEve <- lm(FEve_sc~FEve, data = sev1.comb)
summary(sev1.FEve)

sev1.kde.eve <- lm(kde.evenness_sc~kde.evenness, data = sev1.comb)
summary(sev1.kde.eve)

sev1.FDis <- lm(FDis_sc~FDis, data = sev1.comb)
summary(sev1.FDis)

sev1.kde.dis <- lm(kde.dispersion_sc~kde.dispersion, data = sev1.comb)
summary(sev1.kde.dis)

sev1.FDiv <- lm(FDiv_sc~FDiv, data = sev1.comb)
summary(sev1.FDiv)

sev1.rao <- lm(RaoQ_sc~RaoQ, data = sev1.comb)
summary(sev1.rao)
